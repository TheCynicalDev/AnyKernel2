...
#fstab
backup_file fstab.armani;
replace_file fstab.armani 750 fstab.armani;

# init.armani.rc
backup_file init.armani.rc;
remove_line init.armani.rc "start mpdecision";
#append_file init.armani.rc "post-init.sh" init.armani.patch;

# Disable MP Decison
replace_line init.armani.rc "service mpdecision /system/bin/mpdecision" "#mpdecision /system/bin/mpdecision2";

# Disable MP Decison
replace_line init.armani.rc "service thermal-engine /system/bin/thermal-engine" "#thermal-engine /system/bin/thermal-engine2";
